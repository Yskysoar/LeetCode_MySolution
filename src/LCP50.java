/**
 * @author Yskysoar
 * @createTime 2023-09-15 22:35
 * @description LCP50.宝石补给
 ...
 * 输出：2
 * 解释： 第 1 次操作，勇者 0 将一半的宝石赠送给勇者 2
 * gem = [2,1,3] 第 2 次操作，勇者 2 将一半的宝石赠送给勇者 1
...
public class LCP50 {
    public static void main(String[] args) {
        ...
        int ans = lcp50.giveGem(new int[]{100, 0, 50, 100}, new int[][]{{0, 2}, {0, 1}, {3, 0}, {3, 0}});
