/**
 * @author Yskysoar
 * @createTime 2026-06-13 19:56
 * @description 3838. 带权单词映射
...
public class Solution3838 {
    public static void main(String[] args) {
        Solution3838 solution3838 = new Solution3838();
        String ans = solution3838.mapWordWeights(new String[]{"abcd", "def", "xyz"}, new int[]{5, 3, 12, 14, 1, 2, 3, 2, 10, 6, 6, 9, 7, 8, 7, 10, 8, 9, 6, 9, 9, 8, 3, 7, 7, 2});
    ...
    public String mapWordWeights(String[] words, int[] weights) {
        ...
        for (String word : words) {
            ...
            for (int i = 0; i < word.length(); i++) {
                count += weights[word.charAt(i) - 'a'];
            }
            ans.append((char) ('z' - count % 26));
        }
        return ans.toString();
    }
}
