...
public class Solution617 {
    ...
    public void preorder(TreeNode treeNode) {
        System.out.print(treeNode.val);//输出父节点
        if (treeNode.left != null) preorder(treeNode.left);//如果当前节点的左节点不为空，则递归继续前序遍历
        if (treeNode.right != null) preorder(treeNode.right);//如果当前节点的右节点不为空，则递归继续前序遍历
    }
